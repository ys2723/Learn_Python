# Below is a code to print two numbers while taking input from the user
...
# = Statement (Statements are started with '#', statements are ginoed by the compiler. It is for the reader to understand the codes etc.
